...
<head>
    ...
    <style>
        ...
        .funções {display: inline;}
        a button { margin-left:20px; text-decoration:none; color:#333; font-weight:bold; }
    </style>
</head>
<body>
<header>
...
<div class="container">
    ...
    <?php if ($tipo == 1): // - Servidor AE ?>
        ...
        <a href="/sudae/TCC-PPI-SUDAE-main/ATAS/cadastrar_Ata.php">
            <button type="button">
            <h3>Registrar Ata</h3>
            </button>
        </a>

        <a href="/sudae/TCC-PPI-SUDAE-main/ATRASOS/atrasos.php">
            <button type="button">

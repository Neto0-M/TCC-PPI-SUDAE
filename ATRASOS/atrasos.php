        ...
        <form method="post">
            ...
            <div class="row g-3">
                <div class="col-md-4">
                    ...
                    <input type="text" name="matricula" id="matricula" class="form-control" required value="<?= $edit['matricula'] ?? '' ?>">
                </div>

                <div class="col-md-8">
                    <label class="form-label fw-semibold">Nome do Aluno</label>
                    <input type="text" class="form-control" id="nomeAluno" readonly value="<?= $edit['aluno_nome'] ?? '' ?>">
                </div>
            ...
            <div class="mt-4">
                ...
                <?php endif; ?>
                <a href="../ATRASOS_SCAN/scanner.php" class="btn btn-warning px-4 text-white fw-semibold">Registrar via QRCode</a>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <a href="?delete=<?= $a['idATRASO'] ?>" class="btn btn-sm btn-outline-danger" onclick="return confirm('Excluir este atraso?')">Excluir</a>
                    </td>
                </tr>
                <?php endforeach; else: ?>
                <tr><td colspan="6" class="text-center text-muted">Nenhum atraso registrado.</td></tr>
                <?php endif; ?>
            </tbody>
        </table>
    </div>

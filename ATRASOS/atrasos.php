...
header {
    display: flex;
    justify-content: space-between; /* Espaça os itens de forma que o título vá para a esquerda e o botão para a direita */
...
<body>
    ...
    <a href="/sudae/TCC-PPI-SUDAE-main/DASHBOARD/dashboard.php" class="voltar">
        <button>
            <h3>Voltar</h3>
        </button>
    </a>
